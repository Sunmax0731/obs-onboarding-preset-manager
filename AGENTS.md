...
obs-onboarding-preset-manager は Rank 64 の OBSStreaming プロダクトです。作業はこのリポジトリ内に限定します。

## Scope

- Repository: D:/AI/OBSStreaming/obs-onboarding-preset-manager
- GitHub: https://github.com/Sunmax0731/obs-onboarding-preset-manager
